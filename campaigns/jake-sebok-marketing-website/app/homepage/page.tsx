          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
            <div className="max-w-xl">
              ...
              <p className="font-semibold text-xl text-ap-mid leading-relaxed mb-8">
                Inconsistent execution and low motivation are usually signs the business no longer fits the life you
                actually want. When what you build matches who you are, effort stops leaking, momentum compounds, and
                your impact catches up to your ambition.
              </p>
        ...
        <div className="relative max-w-[1080px] mx-auto px-5 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="group flex flex-col p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-ap-accent/40 hover:bg-white/[0.08] transition-all">
              ...
              <p className="text-white/75 text-base font-medium leading-relaxed">
                Workshop, community, intensive, or coaching. Choose the level of support that matches this season
                instead of guessing your way into more complexity.
              </p>
            </div>
          </div>
