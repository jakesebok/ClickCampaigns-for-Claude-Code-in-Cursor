(function () {
  ...
  var DRIVER_CONTENT = {
    ...
    "The Pleaser's Bind": {
      ...
      mechanism:
        "Low Relationship to Self paired with relatively high Family or Community. A key Relationship to Self reflection (about people-pleasing and abandoning your needs) confirms the pattern. Your importance rating for Relationship to Self is often high because you KNOW self-trust matters but can't hold it when someone else needs something.",
      whatItCosts:
    ...
    "The Imposter Loop": {
      ...
      mechanism:
        "Low Ecology paired with low Relationship to Self. A key Ecology reflection you agreed with confirms the pattern: you suspect you're building something that looks impressive but would trap you if it scaled. Relationship to Self is low because imposter patterns erode self-trust. The broadened signal also checks for high Inner Alignment importance paired with low Ecology, which captures the variant where someone deeply values authenticity but feels their business doesn't reflect it. This 'inauthenticity' variant is as damaging as the classic 'not enough' variant because both create internal resistance to growth.",
      whatItCosts:
    ...
    "The Martyr Complex": {
      ...
      mechanism:
        "Low Physical Health and low Inner Alignment paired with high World/Impact and high Family. Importance ratings confirm: you've rated contribution and family as top priorities while rating your own health and alignment as low. A key Physical Health reflection you agreed with confirms: you sacrifice your body to meet demands.",
      whatItCosts:
    ...
    "The Scattered Mind": {
      ...
      mechanism:
        "Attention & Focus is compromised while Mental/Emotional Health is functional or high, which is the key differentiator from The Escape Artist. Your scores show fragmentation without emotional avoidance: low Attention & Focus paired with weak Execution and Operational Health, plus high Inner Alignment or a high importance rating for Attention & Focus. You know what matters. You care about it. Your attention just won't stay with it long enough to build momentum.",
      whatItCosts:
