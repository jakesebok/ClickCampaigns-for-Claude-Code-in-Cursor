export const testimonials = [
  ...
  {
    quote:
      "Jake is a thoughtful and attentive coach who listens deeply and holds a present space for reflection and growth. His approach has the potential to profoundly impact lives.",
    headline: "Thoughtful and Attentive.",
    author: "Kelly Newsome Georges",
    image: "/images/testimonials/Kelly.jpeg",
  },
  {
    quote:
