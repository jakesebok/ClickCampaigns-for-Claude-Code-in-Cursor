...
These should be **observable behaviors**, not vague compliments.

**Angles to consider:**
- How they act under pressure (calm, decisive, resilient, courageous)
- How they treat people when they have power (fairness, respect, candor, generosity)
- What standards they refuse to negotiate (integrity, excellence, responsibility)
- How they set boundaries (saying no, protecting family, protecting health)
- How they handle conflict (direct, kind, honest, repair-focused)
- How they relate to work (craftsmanship, focus, consistency, long-term thinking)
- How they relate to themselves (self-trust, discipline, humility, emotional regulation)

**Be specific:**
- Vague: "smart" → Specific: "explains complex things simply without making people feel small"
- Vague: "nice" → Specific: "tells the truth with care, even when it's uncomfortable"
- Vague: "hard-working" → Specific: "finishes what they start and protects deep work blocks"

| Person | Quality 1 | Quality 2 | Quality 3 | Quality 4 | Quality 5 |
|--------|-----------|-----------|-----------|-----------|-----------|
|        |           |           |           |           |           |
|        |           |           |           |           |           |
|        |           |           |           |           |           |
...
- One moment from **adolescence or early adulthood**
...
|----------|-------------------|-------|
| Owner pay (baseline personal take-home) |  |  |
| Taxes set-aside (estimate) |  |  |
| Business fixed costs (rent, software, contractors, etc.) |  |  |
...
- Let your answers be **specific, sensory, and human**.
...
## Exercise 1 — Peak Moments

Paste your Peak Moments from your Pre-Work Packet into the table below, then complete the columns to the right.

| Moment / Story (What happened?) | Who was impacted? | What was the transformation? | What mattered most to me? (Values/need) |
|---------------------------------|-------------------|------------------------------|-----------------------------------------|
|                                 |                   |                              |                                         |
|                                 |                   |                              |                                         |
|                                 |                   |                              |                                         |
...
> - Keep your tone human and precise; no marketing buzzwords.
...
**Chosen Cause (rewrite clean):** A world where…
...
>
> **How to use:** Move fast at first (capture raw data), then slow down (pattern recognition and selection). Be honest. Choose what's true—not what sounds impressive.

---

## Step 1 — Choose 5 People You Admire

Pick people you genuinely respect. They can be known personally or public figures. Aim for variety (different contexts/roles).
...
## Step 2 — Extract 5 Qualities You Admire in Each Person

Avoid vague traits like "nice" or "smart." Make them specific and observable (how they behave).
...
> You are helping me extract CORE VALUES from a list of admired qualities.
>
> TASK:
> 1) Convert each quality into a value word or value phrase (1–3 words max).
> 2) Merge duplicates / near-duplicates (e.g., "growth-minded" and "loves learning").
> 3) Count frequency: how many times each value-theme appears across the whole list.
> 4) Output:
>    A) A ranked list from MOST frequent → least frequent (top 15).
>    B) A short "theme definition" for each top 10 value (one sentence).
>    C) 1–2 observable behavior examples for each top 10 value.
>
> RULES:
> - Make values operational (how it shows up), not vague (avoid "nice," "good," "smart").
> - Keep language plain and human (no corporate buzzwords).
> - If a quality could map to multiple values, choose the most accurate based on meaning.
>
> [PASTE YOUR QUALITIES TABLE HERE]

---

## Step 4 — Your Emerging Top Values (ranked)

Paste your AI-ranked top values here (top 10–15).

| Rank | Value (word/phrase) | Frequency | 1-Sentence Meaning (in your words) |
|------|---------------------|-----------|-------------------------------------|
|      |                     |           |                                     |
|      |                     |           |                                     |
|      |                     |           |                                     |
...
## Step 5 — Narrow to Your Top 5 (Trade-Off Test)

In the same AI chat window, paste the following prompt. Answer each of the questions it asks you until you are left with your top 5 core values.

### AI Prompt (copy/paste):

> You are my values-sorting assistant. Help me identify my Top 5 core values from the list below using a forced-choice trade-off test.
>
> **Input rules (critical):**
> - I can answer with A/a or B/b (upper/lower case both valid).
> - Also accept me typing the value name (or an unambiguous short form) as my choice.
> - Normalize my response by trimming whitespace and converting to lowercase.
> - If unclear, ask: "Reply with A or B (or type the value name)." Then repeat the same matchup once.
> - Ask one matchup at a time and wait.
>
> **Phase 1 — Repeated Champion (find Top 5)**
> Run a king-of-the-hill ladder repeatedly.
> - Start with the first value in the current pool as the "champion."
> - Compare champion vs next value in the pool.
> - The winner becomes the new champion.
> - Continue until the champion has faced every other value once.
> - The final champion is the winner of that ladder.
> - Repeat: remove each winner, run a new ladder, until you have Rank #1–#5.
>
> After Phase 1, show me the provisional Top 5 in order and the remaining values listed as "not in Top 5."
>
> **Phase 2 — Sanity Check (Top 5 mini round-robin)**
> Compare every pair among the Top 5 exactly once. Keep a win count. Output Final Top 5 ranked by wins. Run tie-breakers if needed.
>
> **Question format:** "Which matters more to you right now: A) [Value] or B) [Value]?"
>
> Start Phase 1 Ladder #1 now with the first matchup only. Randomize the pool order before starting.
...
What are you currently tolerating that contradicts what you said you want? (Where is your life saying one thing while your calendar, habits, or commitments say another?)
...
What is staying in misalignment costing you? (Energy, relationships, peace, money, health, self-respect, time, opportunity.)
...
If you could only do one thing in the next 7 days to move toward alignment, what would it be?
...
What part of you might resist this change? (Fear, a protective part, an old story, a comfort zone, an identity you've outgrown.)
...
What would make alignment easier? (A person, a system, a boundary, a conversation, accountability, permission.)
...
## Step 1 — Cover the Non-Negotiables (Baseline Needs)

List what must be true financially for you and your business to feel stable (not stressed). *Paste the numbers from your Pre-Work Packet.*

| Category | What It Includes | Annual Amount ($) |
|----------|------------------|-------------------|
| Owner pay (baseline) | Minimum personal take-home to feel stable |  |
| Taxes set-aside | Estimated combined taxes on owner income + business profit |  |
| Business fixed costs | Rent, software, insurance, contractors, subscriptions |  |
| Debt obligations | Personal + business debt payments |  |
| Buffer / reserves | Emergency fund / cash cushion / runway |  |

**Baseline Needs Total (annual):**
...
Required Revenue finances your baseline + desires + impact. Target Revenue adds a reality buffer so you don't miss the mark due to variance.
...
*If you choose Ads, add annual ad spend to Business Fixed Costs in Step 1 and re-check Target Revenue.*
...
## 0) Re-Anchor (2 minutes)

Write the sentence that brings you back to what matters:
...
## 1) Choose Your Lead Lane (5 minutes)
...
## 2) Your "Someday" Outcomes (6–8 minutes)

Write one sentence per lane. Make it measurable or vividly observable.

| Lane | Someday Outcome (1 sentence) |
|------|------------------------------|
| Business / Money |  |
| Home / Relationships |  |
...
| Trigger Plan (when I feel resistance/distraction, I will…) |  |
...
## 6) What Will Try to Stop You? (and what you'll do instead)

| Likely Sabotage / Obstacle | Clean Response (boundary, rule, request, adjustment) |
|----------------------------|------------------------------------------------------|
|                            |                                                      |
|                            |                                                      |
|                            |                                                      |
...
- Replace every [BRACKETED FIELD] using the Field Map below.
- If a field is missing in the worksheets, write: [NEEDS INPUT] (do not guess).
...
My definition: [BRACKET: VALUES #1 definition]
In action it looks like: [BRACKET: VALUES #1 behaviors]
Boundary it requires: [BRACKET: VALUES #1 boundary]

Value #2: [BRACKET: VALUES Top 5 #2]
Definition: [BRACKET: VALUES #2 definition]
Behavior: [BRACKET: VALUES #2 behaviors]
Boundary: [BRACKET: VALUES #2 boundary]

Value #3: [BRACKET: VALUES Top 5 #3]
Definition: [BRACKET: VALUES #3 definition]
Behavior: [BRACKET: VALUES #3 behaviors]
Boundary: [BRACKET: VALUES #3 boundary]

Value #4: [BRACKET: VALUES Top 5 #4]
Definition: [BRACKET: VALUES #4 definition]
Behavior: [BRACKET: VALUES #4 behaviors]
Boundary: [BRACKET: VALUES #4 boundary]

Value #5: [BRACKET: VALUES Top 5 #5]
Definition: [BRACKET: VALUES #5 definition]
Behavior: [BRACKET: VALUES #5 behaviors]
Boundary: [BRACKET: VALUES #5 boundary]
...
Weekly partner/referral asks: [BRACKET: REV referral asks]
Weekly nurture touches: [BRACKET: REV nurture touches]
Quality screen rules (must-have criteria): [BRACKET: REV screen rules]

ADS LANE (weekly operating targets)
Offer/lead magnet: [BRACKET: REV ads offer]
Opt-in rate: [BRACKET: REV opt-in rate]
Cost per lead (CPL): [BRACKET: REV CPL]
Booked call rate: [BRACKET: REV booked call rate]
Weekly ad spend: [BRACKET: REV weekly ad spend]
Annual ad spend: [BRACKET: REV annual ad spend]
CAC target: [BRACKET: REV CAC]
ROAS target: [BRACKET: REV ROAS]

Conversion Quality Check (Non-Negotiable)
If close rate is below [BRACKET: REV threshold; else 25%] OR QC→sales call rate is below [BRACKET: REV threshold; else 50%], you MUST:
- diagnose qualification + messaging,
- tighten the pre-call screen,
- recommend offer/positioning adjustments before increasing volume.

6) CAPACITY CHECK + LEVERS (HOW WE PREVENT BURNOUT)
Capacity Reality
...
2) [BRACKET: Value 2 + boundary]
3) [BRACKET: Value 3 + boundary]
...
Service: [BRACKET: signature contribution + how business enables cause]

REVENUE + OPERATIONS
Required Annual Number: [BRACKET]
Target Revenue: [BRACKET]
...
You are an expert Aligned AI Business Agent. Your job is to PATCH my existing "ALIGNED AI OS UPGRADE — MASTER CONTEXT (v1)" without changing its structure.
...
- Only change fields I explicitly mark for update.
- If I provide new info for a field: replace ONLY that field's content.
...
- Keep language strong, clear, high-stakes, emotionally resonant—but never marketing fluff.
- At the end, include a short "PATCH LOG" listing exactly what changed (field name + old → new in 1 line each).

FIELD NAMING (to ensure accurate patching)
Each update I give will specify:
- SECTION (0–8) and FIELD NAME exactly as labeled in the Master Context Doc, or
- A bracket label from the list below (recommended).
...
2) Parse the Update Notes and map each update to its exact field.
3) Apply patch updates only to those fields.
4) Recompute ONLY dependent math fields if—and only if—I explicitly updated any upstream numbers.
5) Output the updated Master Context Doc and updated Summary Sheet.

INPUTS I WILL PROVIDE
A) My CURRENT Master Context Doc (full text)
B) My PATCH UPDATE NOTES (the changes)
Optional C) New worksheet excerpts if relevant

===========================
A) CURRENT MASTER CONTEXT DOC (PASTE BELOW)
===========================
[PASTE CURRENT MASTER CONTEXT DOC HERE]

===========================
B) PATCH UPDATE NOTES (PASTE BELOW)
===========================
Write updates using this format:
- [BRACKET_LABEL]: REPLACE WITH -> (new content)
or
- [BRACKET_LABEL]: ADD -> (new content)
or
- [BRACKET_LABEL]: REMOVE -> (exact phrase/item to remove)

[PASTE PATCH UPDATE NOTES HERE]

===========================
C) OPTIONAL NEW WORKSHEET EXCERPTS (PASTE BELOW)
===========================
...
3. "Audit my week for values violations before we plan: where am I about to trade [Value] for speed/approval/money?"

4. "Given my capacity limits, what must be deleted or deferred this week so I don't break my system?"

5. "Translate my Required Revenue math into this week's Qualified Conversations quota and the exact outreach actions to hit it."

6. "Design my 'ideal week' template (Mon–Fri) that I can reuse for the next 90 days."
...
11. "What is my current bottleneck: lead flow, conversion, capacity, offer, pricing, or positioning? Prove it with the numbers we have."
...
15. "If we could only improve one lever by 10% this month, which lever changes everything downstream?"
...
## Qualified Conversations + Sales (8 Questions)

19. "Generate my weekly Qualified Conversation plan based on my lane (Referrals/Ads/Hybrid): actions, time blocks, and scripts."

20. "Design a qualification screen that protects my time and improves conversion. Include must-have criteria and disqualifiers."

21. "My close rate is below target. Diagnose whether the issue is lead quality, offer, messaging, or sales process—then give the fix order."

22. "Turn my revenue target into 'sales needed, sales calls needed, QCs needed' and tell me the weekly numbers."
...
26. "Create a 'QC scoreboard' I can review in 2 minutes each day."
...
## Execution + Nervous System (8 Questions)

35. "When I'm stuck or avoiding, ask me 3 questions that expose the real fear, then give one next action that fits my values."

36. "Design my 'pre-work ritual' and 'shutdown ritual' to protect presence at home and reduce overwork loops."
...
42. "I'm about to default to 'work harder.' Intervene: give leverage options only—price/offer/model/systems/delegation."
