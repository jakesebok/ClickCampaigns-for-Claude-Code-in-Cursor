# Strategic Clarity — All Video Scripts (In Order)

# Video: Why Pre-Work Matters

**Pre-Work Orientation | ~5–8 minutes**

---

## VIDEO SCRIPT

Hey, real quick before we dive in—I want to talk about the Pre-Work Packet and why it matters. Because I know what you're thinking. You're thinking, "Jake, I signed up for the good stuff. Why are you giving me homework before the homework?"
...
Your Pre-Work Packet is the starting coordinates.
...
**Plan 60 to 90 minutes.** Find a quiet space. Close the tabs. Put the phone in another room. This isn't a "knock it out on your lunch break" situation.

**Fill it in digitally.** We're going to use AI during the exercises, and you'll need to copy and paste your answers. Handwritten is great for journaling. Not great for this.

**Move fast first.** Don't overthink. Don't wordsmith. Don't try to be impressive. Write the first thing that comes to mind. We can refine later. Speed produces honesty. Editing produces performance.

**Don't solve anything yet.** This is input collection, not strategy. You don't need to know the answer. You need to know the raw material. The exercises that follow are where we turn raw material into clarity.

---

### Why It Powers Everything

Here's the part that might surprise you. Everything you write in this packet—and every worksheet that follows—feeds directly into your Aligned Freedom Coach. That Master Prompt at the end of this module? It takes all of your answers and synthesizes them into a personalized operating system for your AFC.

So when you write a peak moment that seems small? Your AFC remembers it. When you write an honest number about your revenue? Your AFC uses it. When you name a quality you admire in someone else? That becomes a core value your AFC holds you to.
...
And remember—the transformation isn't just in the output. It's in the process. You're going to learn things about yourself simply by answering these questions honestly. That's by design.

---

### One More Thing

If you don't know something—especially in the revenue section—write your best guess and put an asterisk next to it. A rough estimate is infinitely more useful than a blank cell. We'll refine during the exercises. But we can't refine nothing.

Alright. Go fill out the packet. Take your time. Be honest. I'll see you in Lesson 1.
...
# Video 0.1 — Welcome to Strategic Clarity

**Module Introduction | ~8–12 minutes**
...
I'm really glad you're here. And I want to be honest with you right up front—this module is going to be different from what you're used to. This isn't a "goal-setting workshop." This isn't "vision board meets spreadsheet." And it is definitely not another motivational pep talk from some bald guy in an online course.
...
**Lesson 8:** We run the Master Prompt and activate your Aligned Freedom Coach.

**Lesson 9:** We walk through the Fire Starters so you know exactly how to use your Aligned Freedom Coach.
...
Okay. Lesson 1. This is where it starts.

I want you to think about something for a second. Think about the last goal you set. Maybe it was a revenue target. Maybe it was a client number. Maybe it was "launch the course" or "hire a VA" or "hit six figures" or "get to seven."

Now ask yourself: **why?**

Not the surface-level "why"—not "because I want financial freedom" or "because I want to help people." Go one layer deeper. *Why* that number? *Why* that milestone? What do you think is on the other side of it?

Because here's what I've learned—and this one hurt when I finally saw it: most of the goals we chase are not the thing we actually want. They're the *vehicle* we think will get us there. And we've confused the vehicle for the destination.
...
An **end goal** is the thing itself. The experience. The feeling. The state of being. The life.

Here's the distinction that changes everything: **money is currency. We trade currency for something. What is it that you actually want to trade it for?**

Think about it. You don't want a million dollars because you love staring at a number in a bank account. You want what that million dollars represents. Freedom to travel with your family without checking the budget. The ability to take three months off and nobody panics. The feeling of walking into a room knowing you're there by choice, not obligation.

*That's* the end goal. The million dollars? That's a means goal.

---

### Why This Matters (Like, Really Matters)

Here's what happens when you confuse means goals for end goals—and I see this *all the time* with the people I work with:
...
That's what happens when means goals run the show.
...
Not achievements. Not milestones. *Experiences.* What do you want to feel? Where do you want to be? Who do you want to be with? What do you want to do just because you're alive?

**2. How do I need to grow?**

What qualities do you need to embody? What patterns do you need to outgrow? What skills would make your life simpler, richer, more aligned? Who do you need to become to live the life you described in question one?
...
**Be human.** "I want to be present with my kids at dinner without checking my phone." "I want to feel rested—like *actually* rested—for the first time in three years." "I want to walk into a room full of people and not perform." Those are real. Those are end goals.

---

### Column by Column

Let me give you some prompts to get unstuck. You don't have to use all of these. Pick the ones that hit.

**Experiences I Want:**
- What do I want to feel more often?
- What do I want my days to actually look like?
- Who do I want to be with?
- What do I want to do "just because I'm alive"?
- If money and time were completely handled, what would I do next Tuesday?

**How I Need to Grow:**
- What qualities do I need to embody? (Courage, patience, boundaries, trust, leadership, calm?)
- What skills would make my life simpler?
- What patterns must I outgrow? (People-pleasing? Overworking? Avoiding hard conversations?)
- Who do I need to become to hold the life I described in column one?

**How I Will Contribute:**
- Who do I want to serve, and how?
- What impact do I want to be known for?
- What problem makes me angry enough to dedicate years to solving it?
- If I could only help one type of person with one type of problem for the rest of my career, who and what?

---

### What to Watch For

As you write, you might notice something: your brain will try to sneak means goals in. It'll say things like "I want to make $500K" or "I want to build a team of 10" or "I want 50,000 followers."
...
After you fill out the three columns, there's an optional reflection at the bottom:
...
**Lesson 2: Your Driving Fire + The Cause Worth Playing For | ~10–15 minutes**

---

## VIDEO SCRIPT

Okay. Lesson 2. This is one of my favorites, and I'm going to tell you why.
...
But almost nobody can tell you *why* they do it. Not "to make money"—that's a result. Not "to help people"—that's so vague it means nothing. The real thing. The fire underneath everything. The flame that was kindled in you before you even knew it had a name—the reason that would keep you doing this work even if nobody was watching, even if it didn't pay, even if it was hard and thankless and slow.

That's what we're after. In the Alignment Arc, we call it your Driving Fire.
...
The first blank is your *contribution*—the thing you do, the impact you make, the gift you bring.

The second blank is the *effect* of that contribution—what becomes possible because you showed up.

For example: "To challenge people to reconnect with who they really are, so that they build lives and businesses that actually reflect what matters to them."

Notice: that's not a service description. It's not "to coach entrepreneurs so that they make more money." It's deeper. It's the *reason* underneath the coaching.
...
*What do these stories have in common? What was I really doing in each of these moments?*

Don't answer yet. Just let the question sit. We'll work it in the next video.
...
### Exercise 1: Expanding Your Peak Moments

In the Pre-Work Packet, you wrote the stories. Now we're going to go deeper. For each story, you're going to fill in three additional columns:

**Who was impacted?** Not just you. Who else was in the room? Who was affected by what you did? Who changed because of that moment?

**What was the transformation?** What shifted? What went from broken to whole, from confused to clear, from stuck to free? What changed in the person, the room, the situation?

**What mattered most to me?** This is the gut check. What value or need was being honored in that moment? Was it connection? Truth? Justice? Freedom? Dignity? Protection? What was the *thing underneath the thing*?

Take your time here. This is where the gold is.

---

### Exercise 2: Theme Mining
...
Don't overthink it. What's the obvious thread? Maybe it's always about helping someone see something they couldn't see before. Maybe it's always about creating safety. Maybe it's always about fighting for the underdog. Whatever it is—name it.

**2. What problem were you helping solve—beneath the surface problem?**

This is crucial. The surface problem might have been "they needed a business plan" or "they were struggling with their marriage" or "the team was falling apart." But underneath that? Maybe the real problem was that they'd lost trust in themselves. Maybe the real problem was that they'd been performing instead of living. Go one level deeper.

**3. What kind of person were you being at your best?**

Not what were you *doing*—who were you *being*? Were you the truth-teller? The steady presence? The person who held space? The one who saw what nobody else saw? The catalyst? Name the role you naturally step into.

**4. What do you consistently fight for, protect, or restore?**

This one is powerful. Look across all the stories. Is there a thing you keep defending? Freedom? Truth? Belonging? Dignity? Agency? Something keeps showing up. What is it?

**5. What do people thank you for that they rarely thank others for?**

What's the compliment you get that feels different? Not "great job" or "you're so smart." The one that makes you stop. The one that feels like they actually *saw* you. "You made me feel like I could be honest." "You helped me trust myself again." "You said the thing nobody else would say."

---

### The Theme Summary

After you answer those five questions, fill in the Theme Summary box:
...
### If You're Using the Solo AI Prompt
...
Okay, you've done the mining. You've got themes. You've got a messy sentence that feels true. Now let's shape it.
...
Three versions. Don't agonize. Don't try to make them perfect. Write one, then write another that says it differently, then write a third that's even simpler. The goal is to triangulate—to find the version that resonates most.
...
- **Body reaction:** Tight? Open? Neutral? Does your chest expand? Does your throat close?
...
- **Outcome or problem** (what changes for them)
...
I'll see you in Lesson 3, where we go find your core values.
...
Alright. Lesson 3. Let's talk about values.

And I know—the moment I say "core values," half of you just rolled your eyes. I get it. You've seen the poster in every corporate lobby. Integrity. Innovation. Excellence. Teamwork. Words so vague they could mean anything, which means they mean nothing.

That's not what we're doing here.

What we're doing is building a **decision filter**. A set of non-negotiable principles that tell you—in real time, under pressure, when the stakes are high—what to protect, what to tolerate, and when to walk away.

Because here's what I've learned: **the quality of your life is determined by the quality of your decisions. And the quality of your decisions is determined by the clarity of your values.**

---

### The "Who's In Your Room" Problem

There's a concept I love—I think it comes from Ivan Misner—called "Who's In Your Room?" The idea is this: imagine your life is a room. And that room has a door. But here's the catch—the door only opens *one way*. Once someone's in, they're in. They don't leave.

Now, if you don't have clear criteria for who gets through that door, what happens? Everyone gets in. The energy vampires. The people who take and never give. The clients who drain you. The partnerships that look good on paper but cost you your peace. They're all in the room. And you can't get them out.

Values are your criteria. They're the bouncer at the door. They tell you: this person, this opportunity, this relationship, this commitment—does it align with what I've decided matters most?

Without values, you let everything in. And a room full of everything is a room full of chaos.

---

### Values Aren't Vague—They're Operational

Here's where most people go wrong. They pick pretty words. Integrity. Authenticity. Growth. Love. And then they put them on a list, maybe in a notebook, maybe on a sticky note, and they never think about them again.

That's decoration. That's not a value system.

A real value has three components:

1. **A definition** — in your words. Not the dictionary definition. *Your* definition. What does this word mean to *you*, in *your* life?

2. **Behaviors** — what does it look like in action? If someone followed you around for a week, how would they see this value showing up? What would you *do*?

3. **A boundary** — what will you *not* tolerate? This is where it gets real. A value without a boundary is just a suggestion. "I value honesty" means nothing if you'll tolerate dishonesty to keep the peace. The boundary is the price of the value.

So when you say "I value integrity," what you're actually saying is: "I define integrity as ________. I practice it by ________. And I will not tolerate ________." That's operational. That's useful. That's a decision filter.
...
Let's say one of your values is "autonomy"—you define it as "the freedom to make decisions based on my own judgment without seeking external validation." Your behavior is "I trust my intuition and make decisions quickly." Your boundary is "I will not work with clients or partners who require me to abandon my judgment for their comfort."

Now imagine someone offers you a big contract. Great money. Prestige. But the terms require you to run every decision through a committee. You'd have no real authority. You'd be performing compliance, not practicing your craft.

Without a values filter, you take the contract because it's "smart." With a values filter, you recognize it immediately: this violates my autonomy value. The boundary is clear. The answer is no.

*That's* what values do. They make the hard decisions easy—not painless, but clear.

---

### How We're Going to Extract Yours

The process is beautifully simple. And you've already done most of the pre-work.

Here's what we're going to do:

1. **Five people you admire.** You listed them in the Pre-Work Packet.
2. **Five qualities per person.** Twenty-five data points of what you admire most in others.
3. **AI-assisted translation.** We convert those qualities into value-words and rank them by frequency.
4. **Forced-choice trade-off test.** We narrow from the top 10–15 down to your Top 5 using a king-of-the-hill ladder.
5. **Operationalize.** For each of your Top 5: definition, behaviors, boundary.

Why do we start with other people? Because when you try to pick your own values from a list, you pick aspirational ones—the ones you *wish* you had. But when you name what you admire in others, you reveal what you *actually* value. The admiration is the clue. If you keep admiring honesty in five different people, honesty is a core value—whether you've been living it or not.

In the next video, I'll walk you through the extraction process step by step.
...
### Steps 1 & 2: Copy From Pre-Work

If you did your pre-work—and I hope you did—Steps 1 and 2 are just copy-paste. Your five people. Your twenty-five qualities. Drop them right into the tables.

If you didn't do the pre-work, take 10 minutes right now to fill it in. Don't skip this. Everything downstream depends on it.

One thing to watch for: make sure your qualities are **specific and observable.** Not "kind." Instead: "remembers what you're going through and checks in without being asked." Not "strong." Instead: "holds an unpopular position calmly when the room pushes back." That level of specificity is what makes the extraction work.
...
### Step 5: The Trade-Off Test

Now here's the hard part. And it's supposed to be hard.

You've got 10–15 values. You need 5. The only way to narrow it down is to force choices.

There's an AI prompt in the worksheet that runs a structured trade-off test. It works like a king-of-the-hill ladder:

- It takes your top 10 values
- It pits them against each other, two at a time
- "Which matters more to you *right now*: A or B?"
- The winner stays. The loser drops.
- It runs the ladder five times to find your Top 5
- Then it runs a sanity-check round-robin among your Top 5 to confirm the order
...
### The Final Table: Operationalize Your Top 5

Once you have your Top 5, fill in the final table. For each value:

**Core Value** — the word or short phrase.
...
Values aren't something you set once. They're something you practice daily. This table is your practice guide.
...
**Lesson 4: The Future You | ~8–12 minutes**
...
This lesson is about the person you're *becoming*. Not the person you wish you were. Not some Instagram-filtered version of your best self. The real, embodied, lived-in version of you—the one who can actually carry the life, the business, and the impact you've been describing in these worksheets.

---

### The Future You

Four domains of growth that, together, create a whole person. We call it **The Future You**—the person you're becoming:
...
I want you to think about three words. Three aspirational words that describe the person you're becoming. Not the person you are today. The person you're building toward. These words should feel like a stretch—but a *real* stretch, not a fantasy.

Examples: Grounded. Decisive. Generous. Disciplined. Calm. Courageous. Present. Honest. Relentless. Tender.

Pick three.

Then we make them operational. For each word, you'll answer:
- When I feel pressure, the version of me I'm becoming responds by...
- The person I'm becoming protects energy by...
- The person I'm becoming makes decisions by...
- A boundary the version of me I'm becoming keeps no matter what is...

See what we're doing? We're not just naming who you want to become—we're defining what it looks like in *practice*. Because "I want to be more present" means nothing without "I put my phone in another room during dinner." Specificity is the bridge between aspiration and reality.

Then: proof. "If someone watched my last 30 days, the clearest evidence I'm becoming this person would be..."

And contrast: "The old version of me would do ________. The version I'm becoming does ________."

That contrast is powerful. It makes the growth visible. And it gives your AI coach something concrete to hold you accountable to.
...
The Social (Relationships) domain asks you to name the people who matter most. And then—this is the part that gets people—it asks you to imagine what they'd say about you in *twenty years*. Three words each. "How would your partner describe why they love you?" "How would your kids describe the kind of parent you were?"

Then it asks: what would they say about the *last week*?

The gap between those two answers? That's the work. That's where growth lives.

And the daily intention: "One way I will intentionally upgrade each of these relationships *this week* is..." Not next month. Not when things calm down. This week.

---

### Skills (Business): What's the Game You're Playing?

The Skills (Business) domain starts with your Primary Field of Interest—the game you're actually playing. Not the twenty games you could be playing. The one you've chosen.
...
This one stings. Because the answer is usually something you've been doing for years. Maybe it's over-delivering. Maybe it's saying yes to everything. Maybe it's checking your phone at dinner. Maybe it's defining your worth by your output.

Whatever it is—name it. Not because naming it fixes it. But because naming it gives you a choice you didn't have before. As long as it's invisible, it runs you. Once you see it, you can decide.
...
Not next month. Not "when things calm down." Seven days. One action. Visible. Measurable.

"I will leave work by 5:30pm on three of the next five days."
"I will have the conversation with [name] I've been avoiding."
"I will block two hours on Thursday for skill development and tell no one they can have that time."
...
**4. Next Right Move.** If you could only do one thing in the next seven days to move toward alignment, what would it be? Not the whole plan. Not the perfect strategy. The *one* thing. The next right move.

**5. Resistance.** What part of you might resist this change? This is important. Every growth edge has a protector. There's a part of you—maybe it's fear, maybe it's comfort, maybe it's an identity you've outgrown—that will fight to keep things the way they are. Name it. Not to defeat it. To *see* it. Because what you can see, you can negotiate with.

**6. Support.** What would make alignment easier? A person. A system. A boundary. A conversation. Permission you haven't given yourself yet. Accountability you haven't asked for. What would actually help?
...
At the bottom of the worksheet, there are two reflection prompts:
...
Those two sentences—if you're honest—are worth more than a hundred hours of strategy. Because they name the leverage point. The place where one change creates a cascade.
...
So now we turn meaning into math.
...
We start at the bottom. What must be true for you to feel *stable*? Not thriving—stable. Not stressed. Not lying awake at 2am wondering if you can make payroll.

This is your floor:
- **Owner pay** — the minimum personal take-home to feel stable
- **Taxes** — estimated set-aside
- **Business fixed costs** — rent, software, insurance, contractors
- **Debt obligations** — personal and business
- **Buffer / reserves** — emergency fund, runway, cash cushion

Add it up. That's your Baseline Needs Total.

If you did your Pre-Work Packet, most of these numbers are already there. Just paste them in.

Here's what I want you to notice about this number: it's not exciting. It's not aspirational. It's *necessary*. And most people have never actually calculated it. They're running a business without knowing the minimum it needs to produce for their life to function. That stops today.
...
We didn't start with "how much do I want to make?" We started with "what do I need to survive?" Then "what does the life I want cost?" Then "what does impact require?"

Most people set revenue goals based on aspiration or comparison. "I want to make $500K because my friend makes $500K." That's a means goal with no foundation.

We're building a revenue target based on *your actual life*—your needs, your desires, and your cause. Every dollar has a job. Every dollar is connected to something that matters to you.

And here's what's powerful about that: when the quarter gets hard, when the launch doesn't go the way you planned, when the doubt creeps in—you know exactly what you're working for. Not a number on a scoreboard. A life.

---

### The Math Continues

In the next video, we're going to add these up into your Required Revenue, add a reality buffer, and then reverse-engineer the weekly behaviors—qualified conversations, sales activities, and capacity checks—that make it real.

For now, finish Steps 1 through 3. Get the numbers down. Don't agonize over exactness—rough estimates are fine. We'll refine later.
...
### Step 4: Required Revenue vs. Target Revenue
...
Now add a **Reality Buffer**—I recommend 10%. Because business isn't linear. Things break. Launches underperform. Clients cancel. The buffer is what keeps you from being one bad month away from panic.
...
**Target Revenue** ÷ **Average Sale Value** = **Sales Needed**

Simple. If you need $300K and your average sale is $10K, you need 30 sales this year.

**Sales Needed** ÷ **Close Rate** = **Sales Conversations Needed**

If you close 30% of your sales conversations, you need 100 sales conversations to get 30 sales.

**Sales Conversations** ÷ **QC → Sales Rate** = **Qualified Conversations Needed**
...
Now, what if the math doesn't work? What if you need 10 QCs per week and your capacity says 4?

That's when we pull levers. And the worksheet asks you to choose:

- **Raise price / increase average sale value** — fewer sales needed for the same revenue
- **Tighten offer / narrow scope** — faster delivery, more capacity
- **Change model** — group, retainer, async, productized — one-to-many instead of one-to-one
- **Hire support / delegate** — buy back your time
- **Reduce commitments** — stop doing low-value work that eats capacity

Notice what's *not* on the list? "Work harder." "Add more hours." "Just hustle through it."

That's not how this works. We optimize for alignment *and* sustainability. If the math doesn't fit your life, we change the math—not your life.

---

### Paste the Numbers

Most of the conversion and capacity numbers should be in your Pre-Work Packet already. Paste them in. If you don't have exact numbers, estimate and mark with an asterisk. We can refine later. But having a rough number is infinitely better than having no number.
...
**Referral Engine** — relationship-based. Partner conversations, introductions, network activation. This is high-trust, high-conversion, lower volume. Best when you have existing relationships, a strong reputation, or a service that's easy to refer.

**Ads Engine** — paid acquisition. Meta, Google, YouTube, whatever platform. This is volume-based, lower-trust initially, requires budget and testing. Best when you have a proven offer, clear messaging, and the capital to invest.
...
Here's a principle I want you to hold: **the highest-quality conversations come from the highest-trust sources.** Referrals convert faster, close at higher rates, and produce better clients. Ads scale faster but require more nurturing. Neither is wrong. But if you're early in your growth or capacity-constrained, referrals are almost always the smarter first engine.
...
This is where we ask: can your current model actually *deliver* this revenue without breaking your values, your health, or your relationships?

The worksheet walks you through it:
- Hours per week you're willing to work (sustainable, not max)
- Delivery hours per sale
- Total delivery hours needed
- Admin and ops hours
- Sales and marketing hours
- Is this sustainable for 12 months?

If the answer is yes—great. You've got a plan that works.

If the answer is no—and it's no for a lot of people the first time they run this math—then we don't push harder. We pull a lever.

The lever options are listed in the worksheet:
- Raise price
- Change the offer (tighter scope, outcome-based)
...
1. **My ONE highest-leverage move is...** — The lever you're pulling.
...
Step back for a second and look at what you have now:
...
Lesson 7. And here's where everything converges.

You've done the vision work. You've done the values work. You've done the math. You know what you want, who you are, what your business needs to produce, and how many conversations it takes per week. Incredible.

But here's the problem with having all of that clarity: **you can see twenty things that need to happen.** And when you can see twenty things, you do twelve of them poorly, three of them half-heartedly, and the five most important ones get pushed to next week.
...
The test is simple: "If this lane improves, which other lanes improve automatically?"

If fixing your business revenue means you stop stressing about money, which means you're more present at home, which means you have the confidence to invest in skills—Business might be your Lead Lane.
...
### Defining Your Someday Outcomes

Before we go narrow, we go wide.

For each lane, write a "Someday" outcome—one sentence that describes what success looks like if this lane is fully realized. Make it measurable or vividly observable.

"Someday: My business generates $500K with 25 hours of work per week and a 6-week waiting list."

"Someday: My kids describe me as the parent who was always present and always honest."

"Someday: My foundation has funded 100 entrepreneurs who wouldn't have had access otherwise."
...
# Video 7.2 — The Arc Chain + Calendar Install

**Lesson 7: Your Vital Action Plan | ~5–8 minutes**
...
This is where the Vital Action framework really earns its keep. We're going to chain your Someday outcome all the way down to what you do in the *next ten minutes*. Each level asks the same question: "What's the Vital Action at this level that makes the next level possible?"

**Someday** → your long-term vision for this lane. You already wrote it.

**5 Years** → what must be true in five years for Someday to be on track?

**This Year** → what must happen this year to be on track for the five-year mark?

**This Quarter** → what's the ONE move this quarter?

**This Month** → what must happen this month?

**This Week** → what's the ONE action this week?

**Today** → what's the most important thing today?

**Right Now** → what are you going to do in the next ten minutes?

Each level feeds the one below it. And each level gets more specific, more concrete, more *doable*. That's the power of the chain. It takes an overwhelming vision and breaks it down until it's one action. Right now. Ten minutes.

Do this for your Lead Lane first. If you have time, repeat for the other lanes. But the Lead Lane is the priority.

---

### Install It on the Calendar
...
It's not. This is the Vital Action. Everything else depends on it.

---

### What Will Try to Stop You

Section 6. The sabotage plan.

I love this part because it's the most honest part of the worksheet. We're not pretending everything will go smoothly. We're *planning* for the resistance.

List your likely sabotage patterns and obstacles. Then—for each one—write a clean response.

"I'll get distracted by a new idea." → "I'll write it in a parking lot and return to the Vital Action."
...
"I'll convince myself that today's exception is okay." → "I'll remember: one exception becomes a pattern. The pattern becomes a habit. The habit kills the Vital Action."

"I'll feel like I'm being selfish." → "I'll remind myself that protecting this block is what makes me better for everyone else. This isn't selfish. This is sustainable."

---

### The Commitment

Section 7. Write it and sign it.

"My next season is built on this Vital Action: ________."

"I will protect it."

Signature. Date.

I know it feels dramatic. That's the point. You're making a commitment to yourself. Not to a coach. Not to an accountability partner. To *you*. And the simple act of writing it down and signing it creates a psychological contract that's harder to break than a verbal intention.

---

### One Last Note

If your Lead Lane is Business/Money, go back and check: does your Vital Action support your Required Revenue from The Revenue Bridge? Does it protect the other lanes—or come at their expense? If your business Vital Action is "do 50 cold calls a day" but your Self (Personal) future says "grounded and present" and your Social (Relationships) future says "protect family dinners"—something's off. Revisit. Realign.
...
Let me explain what we're about to do, because it's unlike anything you've done with AI before.

You know how most people use ChatGPT or Claude? They open it up, they type a question, they get a generic answer. Maybe a good one. But generic. Because the AI doesn't know you. It doesn't know your values. It doesn't know what you want your life to feel like. It doesn't know your revenue targets or your capacity constraints or the fact that you're trying to protect Thursday evenings for your family.
...
**Step 1:** Open your Master Prompt worksheet. You'll see the full prompt template.

**Step 2:** Copy the entire prompt.

**Step 3:** Open your preferred AI—ChatGPT, Claude, Gemini, whatever you like.
...
Then it gives you a recommendation: **YES / NO / NOT NOW** with one sentence explaining why.

That filter alone is worth the entire module. Because how many times have you said yes to something that looked great on paper but violated one of your core values? Or took on a project that helped your revenue but crushed your capacity? The filter catches that. Every time.
...
That's it. Because your AI already knows everything about you, every answer is tailored to your values, your capacity, your goals, and your current season. No re-explaining. No context-setting. Just clarity.

Let me walk you through the categories and highlight a few of my favorites.

---

### Weekly Planning (Questions 1–8)
...
### Strategy + Focus (Questions 9–18)

This category is for when you need to zoom out.
...
### Qualified Conversations + Sales (Questions 19–26)

This is operational execution.

**Question 22** is the math check: *"Turn my revenue target into 'sales needed, sales calls needed, QCs needed' and tell me the weekly numbers."*
...
### Execution + Nervous System (Questions 35–42)

This is the self-coaching category. And it might be the most important one.

**Question 35**: *"When I'm stuck or avoiding, ask me 3 questions that expose the real fear, then give one next action that fits my values."*

That's therapy-grade coaching from an AI that knows your sabotage patterns, your resistance, and your values. It doesn't give you a pep talk. It gives you a mirror and a next step.
...
This one's a boundary. When you feel the pull to grind, you paste this and your AI coach *refuses* to let you hustle. It only gives you leverage options. Because your Aligned Freedom Coach is optimized for alignment + sustainability + impact + revenue—in that order. "Work harder" is always the last resort.
...
Let me zoom all the way out for a second.

You walked into this module—maybe skeptical, maybe hopeful, maybe a little of both. And over the course of nine lessons, you:

- Named what you actually want (not what you think you should want)
- Found the purpose underneath the business
- Defined five non-negotiable values with operational teeth
...
And the beautiful thing? It grows with you. Monthly Patch Notes keep it current. The worksheets can be revisited quarterly. The Fire Starters never expire. Your Aligned Freedom Coach gets smarter as you get clearer.
