# Strategic Clarity Module — Complete Outline

**Aligned Power | Stage 2**

> Connect your daily actions directly to the outcomes you actually want. Stop chasing means goals and start building a life and business that funds your end goals without compromising who you are.
...
| Metric | Count |
|--------|-------|
| Total Lessons | 10 (Intro + Pre-Work + Lessons 1–8 + Lesson 9) |
| Total Videos | 18 |
...
|-------|------|------|----------|
| Video 0.1 — Welcome to Strategic Clarity | `documents/video-0.1-module-introduction.md` | Script | ~8–12 min |
...
### Lesson 8: Aligned Freedom Coach — Master Prompt

| Asset | File | Type | Duration |
|-------|------|------|----------|
| Video 8.1 — Master Prompt + Monthly Patch Notes | `documents/video-8.1-aligned-ai-os.md` | Script | ~8–12 min |
| Master Prompt + Monthly Patch Notes | `worksheets/08-master-prompt.md` | Worksheet | — |
...
Lesson 7: Vital Action — What's the single move that makes everything else easier?
    ↓
Lesson 8: Aligned Freedom Coach — Feed it all into the Master Prompt → personalized AI coach
    ↓
...
All video scripts written in Jake Sebok's voice per `Resources/Jake's Voice/JAKE-SEBOK-WRITING-STYLE.md`:
- Warm, conversational, invitational
- Teaching → Reframe → Authority/Story → Application → Invitation
- Self-aware humor, grounded (not preachy)
- Signature phrases: "Let's get after it," "Depth beats perfection," "You are not broken"
