...
/**
 * /card — Jake's digital business card. Standalone (the site header/footer are
 * suppressed for this route by components/SiteFrame.tsx), mobile-first, branded
 * to Aligned Power. Show the QR on your phone; a scan opens this page; "Save my
 * contact" downloads the vCard (app/card/vcard/route.ts). All contact data
 * lives in lib/card/contact.ts.
 */
