...
TASK: Generate the APOS MASTER CONTEXT (v1) and ALIGNMENT BLUEPRINT SUMMARY SHEET.
...
export const MORNING_PROMPTS = [
  ...
  "APOS check-in. Before the day starts: what are you grateful for, and what are you committed to?",
