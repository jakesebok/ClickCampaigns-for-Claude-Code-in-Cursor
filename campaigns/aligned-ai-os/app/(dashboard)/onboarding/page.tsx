    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <p className="text-muted-foreground max-w-md mb-6">
          Your worksheets have been synthesized into Aligned Freedom Coach. Your coach
        ...
        <div className="max-w-2xl w-full space-y-8">
          <div className="text-center space-y-3">
            <h1 className="text-3xl font-serif font-bold">
              Build Your Aligned Freedom Coach
            </h1>
      ...
      <div className="flex flex-col items-center justify-center h-full p-8">
        <div className="max-w-lg w-full space-y-6 text-center">
          ...
          <p className="text-muted-foreground">
            ...
            (Google Doc exported as .docx, or .txt/.md). Aligned Freedom Coach will synthesize everything into
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8">
        <div className="max-w-lg w-full space-y-6 text-center">
          ...
          <p className="text-muted-foreground">
            Aligned Freedom Coach will ask you a series of questions to understand your
