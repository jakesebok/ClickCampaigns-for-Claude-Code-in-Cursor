        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {step === "onething" && "The ONE THING that makes everything else easier"}
            </p>
          </div>
          {allAnswered() && (
          ...
          {step === "onething" && (
            <>
              <div className="rounded-xl border border-border p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  What&apos;s the one thing that would make every other reflection on
                  this page either easier or completely unnecessary?
                </p>
                <textarea
                  value={oneThing}
                  onChange={(e) => setOneThing(e.target.value)}
                  placeholder="The ONE THING for next week..."
                  rows={3}
                  className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
