# APOS — Aligned Performance Operating System
...
APOS is linked from that page. Workshop attendees get coupon codes for 30-day free access.

## User Tiers

| Tier | Trial | How they enter |
|------|-------|---------------|
| General | 7 days | Signs up on APOS website |
